...
type MobileNetPrediction = Awaited<ReturnType<MobileNetModel['classify']>>;
...
const mapPredictionToBodyPart = (predictions: MobileNetPrediction): BodyPartKey | null => {
  ...
  const analyzeImageAI = async () => {
    ...
    try {
      ...
      const detectionReasoning = {
        ...
        metrics,
        detectionReasoning,
        detectionReasoning: 'Kidney/abdomen keywords, tightened heuristics, and exposed detection reasoning to UI for debugging',
